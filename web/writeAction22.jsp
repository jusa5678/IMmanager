...
<body>
	...
	// 세션 여부 검출.
		...
		String directory = "/usr/local/apache-tomcat-8.5.39/webapps/ROOT/ipchalimg";
		...
		startsell = Integer.parseInt(multipartRequest.getParameter("sell"));
		
		BbsDAO2 nn = new BbsDAO2();
		
		int bbsID = nn.getNext();
		
		//bbs테이블에 저장.
		new BbsDAO2().write(bbsTitle, user_id, bbsContent, fileRealName, fileUrl, fileRealName2, fileUrl2, fileRealName3, fileUrl3, startsell);
		// sell_sub 테이블에 저장.
		new BbsDAO2().sub_write(f_name, f_size, f_material, f_color, f_manu, f_date);		
		
		new PopDAO().popWrite(bbsID,user_id,startsell);
