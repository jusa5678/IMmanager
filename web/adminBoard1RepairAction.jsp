	...
	<% 
		...
		if(result == -1){ // 오류가 날 경우.
			...
			try { 
				...
				d1.logWrite(3, String.valueOf(bbsID) );					
			} catch (Exception e) { 
			} 				
			script.println("<script>");
			script.println("alert('성공적으로 복구하였습니다.')");			
			script.println("location.href = 'adminBoard1.jsp'");
			script.println("</script>");
