...
<nav class="navbar navbar-expand-lg navbar-light" style="margin-top:20px; background-color: #F1BDBD;">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent" style="padding-top:30px">
   ...
   <%
		...
		Community bbs = new CommunityDAO().getBbs(bbsID);
		// 조회수 증가 쿼리 실행.
		CommunityDAO a = new CommunityDAO();
		a.getView(bbsID);
   ...
   %>
        ...
        <div class="container">
            ...
            <div class="row" style="margin-top: 50px;">
                ...
                %>
               		<div id="top_0"><img src="upload2/<%=bbs.getFileName()%>" style="width:82%; height:430px; "></div>
                <%
                	}else if(bbs.getFileName3() == null){
                %>
             		<div id="top_0"><img src="upload2/<%=bbs.getFileName()%>" style="width:82%; height:430px; "></div>
            		<div id="top_1"><img src="upload2/<%=bbs.getFileName2()%>" style="width:82%; height:430px; "></div>
               <%
                	}else{
               %>      
					<div id="top_0"><img src="upload2/<%=bbs.getFileName()%>" style="width:82%; height:430px; "></div>
            		<div id="top_1"><img src="upload2/<%=bbs.getFileName2()%>" style="width:82%; height:430px; "></div>	
					<div id="top_2"><img src="upload2/<%=bbs.getFileName3()%>" style="width:82%; height:430px; "></div>
				<%
                	}
				%>
                ...
                %>
                	<ul id="ul_btns">
						<a href="#" id="btn_0"><li><img src="upload2/<%=bbs.getFileName()%>" style="width:85px; height:90px;"></li></a>		    
					</ul>
				<%
                	}else if(bbs.getFileName3() == null){
				%>
               		<ul id="ul_btns">
						<a href="#" id="btn_0"><li><img src="upload2/<%=bbs.getFileName()%>" style="width:85px; height:90px;"></li></a>
						<a href="#" id="btn_1"><li><img src="upload2/<%=bbs.getFileName2()%>" style="width:85px; height:90px; padding-left: 3px"></li></a>
					</ul>
				...
				%>
					<ul id="ul_btns">
						<a href="#" id="btn_0"><li><img src="upload2/<%=bbs.getFileName()%>" style="width:85px; height:90px;"></li></a>
						<a href="#" id="btn_1"><li><img src="upload2/<%=bbs.getFileName2()%>" style="width:85px; height:90px; padding-left: 3px"></li></a>
						<a href="#" id="btn_2"><li><img src="upload2/<%=bbs.getFileName3()%>" style="width:85px; height:90px; padding-left: 3px"></li></a>
					</ul>
                ...
                <%
                	if(bbs.getFileName() == null){ // 이걸 응용하기. 파일 입출력에서 순서대로 저장하고, 만약 저장한게 하나도 없을 경우(1에도 없을 경우) 지정 이미지 출력.
                		%>
                ...
                <div class=".col-md-12" style="width:100%; margin: 10px;">
                  ...
                  <div class=".col-md-12" style="width:100%; margin: 10px;">
                        <h3>댓글</h3>
                        <!-- 추천 쿼리 실행 -->
                     <form action="./commuRecommend.jsp"> 
                ...
                <div class=".col-md-12" style="width:100%; margin: 10px;">
                  ...
                  <tbody> <!-- 테이블의 몸통 -->
                      <% 
                      	...
                      	ArrayList<Commu_comment> comment = commentDAO.getComment(bbsID);
					...
					<tr>
						...
						<td style="width:20%"><form class="form-inline" action="./commuCommentDeleteAction.jsp">
