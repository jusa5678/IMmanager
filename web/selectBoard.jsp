   ...
   <!-- center 부분 -->
       ...
       <br>
         <div class="row"  style="float: right;">
              ...
              <!-- 검색 영역 -->
              <form name="select" class="form" role="form" action="./selectBoard.jsp" >
      	 ...
      	 <% 
    	    ...
    	    %>
    	      <!-- 글쓰기 페이지 이동. -->
              <a href="./write.jsp"> 
              <input id="login_button" type="submit" class="btn btn-danger" value="글쓰기" > 
              </a>
           ...
           %>
            ...
            <% 
					...
					if(selectContent == ""){ // 검색 내용에 아무것도 입력 안 할시.
						...
						ArrayList<Bbs> list =  bbs.getSelect(selectType, selectContent);
                ...
                <div class="col-md-3">
                <a href="sellBoarding.jsp?bbsID=<%= list.get(i).getBbsID() %>" class="thum bnail">
                <div class="col-md-12" style="margin-left:20px">
                        <p id="title"><%= list.get(i).getBbsTitle() %></p></div>
                        <img id="img" src ="upload/<%=list.get(i).getFileName() %>">
                    </a>
