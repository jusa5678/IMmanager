...
<div class="container">
	...
	<div class="row">
		<form name="writeForm" action="./writeAction2.jsp" method="post" enctype="multipart/form-data">
		...
		<!-- sell_sub 테이블에 저장되는 항목들. -->
					...
					<input type="text" class="form-control" placeholder="가구 사이즈를 쓰세요" name="f_size" maxlength="20">
                     ...
                     <div class="row">
                          ...
                          <div class="col-xs-6 col-md-6">
                            <label>가구 색상</label>
						<input type="text" class="form-control" placeholder="가구 색상를을쓰세요" name="f_color" maxlength="20">
                          </div>
                     </div><br>
                     <div class="row">
                          <div class="col-xs-6 col-md-6">
                          ...
                          <div class="col-xs-6 col-md-6">
                            <label>가구 구매일</label>
					<input type="text" class="form-control" placeholder="가구 구매일을 쓰세요" name="f_date" maxlength="20">
                          </div>
                     </div> <br>
                     
                     
                     <label>가격 </label>
                        <input type="number" name="sell" class="form-control input-lg" placeholder="가격을 입력" />
