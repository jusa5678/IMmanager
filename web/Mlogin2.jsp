...
<body>
    <%
            ...
            String id = null; // 앱에서 넘어오는 아이디 저장.
            String pw = null; // 앱에서 넘어오는 비밀번호 저장.

            id = request.getParameter("mId"); 
            pw = request.getParameter("mPw");
            ...
            if(id == null){
    			...
    			script.println("</script>");
            }else if(stDAO.getStopUser(id)==1){
            	PrintWriter script = response.getWriter();
            	script.println("<script>");
    ...
    <div id="al" class="col-lg-4">
       <a href="./main.jsp">
        ...
        <div class="jumbotron" style="padding-top:20px;">
        	<!-- 로그인  영역 -->
            <form id="form1" method="post" action="loginAction2.jsp">
            	<!-- 아이디 입력 -->
                <div class="form-group">
                    <input type="text" class="form-control" value="<%= id%>" name="user_id" maxlength="20">
                </div>
                
                <!-- 비밀번호 입력 -->
                <div class="form-group">
                    <input type="password" class="form-control" value="<%= pw%>" name="user_password" maxlength="20">
                </div>
