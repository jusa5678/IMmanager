			...
			<ul class="box">
				...
				<li><a href="#">게시글 관리</a></li>
					<ul>
						...
						<li><a href="adminBoard2.jsp"><strong>판매 게시판</strong></a></li>
					</ul>
		...
		<div id="content" class="box">
			...
			<table class="nostyle">
				...
				<% 
					...
					ArrayList<Bbs> list = bbsDAO.getListAd(pageNumber,maxlist);
...
<script>
	function repairQ(x){
		if(confirm("정말 복구 하시겠습니까?")){
			location.href='adminBoard2RepairAction.jsp?bbsID='+x;
		}else{
			return;
		}
	}
	...
	function deleteQ(x){
		if(confirm("정말 영구삭제 하시겠습니까?")){
			location.href='adminBoard2DeleteAction.jsp?bbsID='+x;
		}else{
			return;
		}
	}
	function deleted(x){
		if(confirm("정말 삭제 하시겠습니까?")){
			location.href='adminBoard2DeleteAction2.jsp?bbsID='+x;
		}else{
			return;
		}
	}
